import { EventHandler, EventHandlerUserOnly } from "../events"
...
/**Creates an instance of the document handler */
export const createDocumentHandler = (mainDocument: Document) => {
    return {
        handler: new DocumentHandler(mainDocument)
    };
}